...
namespace CardSystem
{
    ...
    public sealed class Card : ScriptableObject
    {
        ...
        public void Activate(GameObject user)
        {
            ...
            GameContext.Instance.Act(ChangeMana, new ManaArgs { Amount = -cardCost, IncludeRedSlider = false });
        ...
        public void OnHitTarget()
        {
            if (cardType == CardType.Attack)
            {
                ...
                GameContext.Instance.Act(ChangeMana, new ManaArgs { Amount = this.cardCost, IncludeRedSlider = true });
            }
        }
        ...
        private void ActivateHealEffect(GameObject user)
        {
            ...
            GameContext.Instance.Act(ChangeMana, new ManaArgs { Amount = healAmount, IncludeRedSlider = true });
        }
