...
public class StartCountdownEvent : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _inputManager = GameContext.Instance.GetService<InputManager>();
    }
    void OnEnable()
    {
        ...
        GameContext.Instance.Input.SetCardInputs(false);
        GameContext.Instance.Input.SetPlayerInputs(false);
        GameContext.Instance.Input.SetUIInputs(false);
        _isOnActive = true;
    ...
    void OnDisable()
    {
        ...
        GameContext.Instance.Input.SetCardInputs(true);
        GameContext.Instance.Input.SetPlayerInputs(true);
        GameContext.Instance.Input.SetUIInputs(true);
        for (int i = 0; i < _objects.Count; i++)
        {
