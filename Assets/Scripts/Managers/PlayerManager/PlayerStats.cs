...
public class PlayerStats : MonoBehaviour
{
    ...
    //Move these to scene manager later probably?
    ...
    private void IsGameOver(bool gameOver)
    {
        ...
        GameContext.Instance.Input.SetPlayerInputs(!gameOver);
        GameContext.Instance.Input.SetCardInputs(!gameOver);
    }
    void OnDisable()
    {
    ...
    //Probably gonna rework / move this later
    void Start()
    {
        if (!_bar)
        {
